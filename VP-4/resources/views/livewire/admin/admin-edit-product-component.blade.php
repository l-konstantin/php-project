        ...
        <div class="content-middle">
            <div class="content-head__container">
                <div class="content-head__title-wrap">
                    <div class="content-head__title-wrap__title bcg-title">Редактировать продукт</div>
                </div>
            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" wire:submit.prevent="updateProduct">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="file" class="input-field" wire:model="newimage"/>
                                                    @if($newimage)
                                                        <img src="{{$newimage->temporaryUrl()}}" width="120" />
                                                    @else
                                                        <img src="{{asset('img/cover/products')}}/{{$image}}" width="120" />
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="form-group">
