...
function proceedOrder()
{
    try {
        ...
        $need_change = !empty($need_change) ? "Безналичная оплата" : "Потребуется сдача";
        ...
        if (!empty($user)) {
            ...
            $query = "insert into users (name, email, phone) value ('$name', '$email', '$phone')";
        ...
        $message = "<br>Уважаемый " . $name . ", Ваш заказ № " . $order_id . "<br>DarkBeefBurger за 500 рублей, 1шт. " . "Успешно размещен<br>".
        ...
        if ($orders_count == 1) {
            ...
            $message .= "Спасибо, за ваш {$orders_count} заказ!<br>";
        }
